...
y2 = 0.0
# gain = 10000.0
gain = 10000.0 * 2**16    # Comparing to filter 16 bits/sample for this
# filter we need to choose larger amplitude
...
# Generally, the more bits per signal we have the less quantization error we get.
