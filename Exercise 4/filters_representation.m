...
[b, a] = butter(2, [f1, f2]*2/Fs,'bandpass');

%% Higher - order Band-pass Butterworth filter
% Band-egdes (Hz)
f1 = 700; 
f2 = 1000;

% b, a : difference equation coefficients for Butterworth filter 
[b, a] = butter(6, [f1, f2]*2/Fs, 'bandpass');
...
[b, a] = cheby2(6, Rs, [f1, f2]*2/Fs, 'bandpass');

%% An elliptic band-pass filter
f1 = 700; 
f2 = 1000;
Rp = 1; % Passband ripple in dB
Rs = 50; % Stopband attenuation in dB
[b, a] = ellip(5, Rp, Rs, [f1, f2]*2/Fs, 'bandpass');
